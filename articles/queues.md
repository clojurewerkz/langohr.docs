...
This guide covers Langohr 3.2.x.
...
This handler will be invoked when a confirmation (the
...
Consumer tag is returned by `langohr.basic/consume` or may be already
...
In AMQP parlance this is know as *QoS* or *message
